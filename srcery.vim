...
" sizeof, "+", "*", etc.
hi! link Operator SrceryRed
" Any other keyword
hi! link Keyword SrceryRed

" Variable name
hi! link Identifier SrceryGreen
" Function name
...
hi! link goDeclType SrceryCyan
hi! link goBuiltins SrceryGreen
hi! link goType SrceryCyan
hi! link goSignedInts SrceryCyan
hi! link goUnsignedInts SrceryCyan
hi! link goFloats SrceryCyan
hi! link goComplexes SrceryCyan
hi! link goString SrceryYellow
hi! link goRawString SrceryOrange
highlight SyntasticError ctermbg=88
highlight SyntasticWarningLine ctermbg=240
